        ...
        <div className="h-full w-full">
            <form action="submit" className="flex flex-col justify-between p-4 gap-5">
                <div className="flex flex-col md:flex-row justify-between gap-2">
                    <div className="flex md:flex-row justify-center gap-1 md:gap-5">
                ...
                <textarea name="description" id="desc" placeholder="description" className="resize-none focus:outline-none outline-none hover:border-black"></textarea>
            </form>
        </div>
    )
}